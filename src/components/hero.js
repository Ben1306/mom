...
export default function Hero(props) {
    return (
        <div className="w-full flex flex-col gap-8 h-[800px] justify-center items-center relative">
            ...
            <Title title={"Best"} className={"mr-80 relative z-10"} delay={4}/>
            <Title title={"Mom"} className={"relative z-10"} delay={6}/>
            <Title title={"Ever!"} className={"ml-80 relative z-10"} delay={5}/>
